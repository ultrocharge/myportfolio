  ...
  return (
    ...
    >
      ...
      <div className="-mt-5 max-w-2xl text-center leading-7">
        <p className="mb-4">
          I&apos;m Oliver Elias, I&apos;m a Full Stack developer based in
          Germany. <br />
          ...
          ventures. My core stack is React, Next.js, TypeScript, Tailwind CSS
          and Node.js. I am also familiar with Nuxt.js and Python. I am always
